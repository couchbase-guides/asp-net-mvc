...
With this guid you'll create a "hello world" ASP.NET MVC web application that uses link:http://developer.couchbase.com[Couchbase].
...
`/Starter/Models/Person.cs`
[source,c#]
----
include::starter_complete/Starter/Models/Person.cs[]
----
...
`/Starter/Models/PersonRepository.cs`
[source,c#]
----
include::starter_complete/Starter/Models/PersonRepository.cs[]
----
